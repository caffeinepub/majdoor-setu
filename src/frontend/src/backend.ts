...
export class Backend implements backendInterface {
    ...
    async applyToJob(arg0: Application): Promise<ApplicationId> {
        if (this.processError) {
            try {
    ...
    async createWorker(arg0: Worker): Promise<WorkerId> {
        if (this.processError) {
            try {
                const result = await this.actor.createWorker(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchJobsBySkillAndLocation(arg0: string, arg1: string): Promise<Array<Job>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchJobsBySkillAndLocation(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async searchWorkersBySkillAndLocation(arg0: string, arg1: string): Promise<Array<Worker>> {
        if (this.processError) {
            try {
                const result = await this.actor.searchWorkersBySkillAndLocation(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateApplicationStatus(arg0: ApplicationId, arg1: string): Promise<void> {
        if (this.processError) {
            try {
    ...
    async updateWorker(arg0: WorkerId, arg1: Worker): Promise<void> {
        if (this.processError) {
            try {
